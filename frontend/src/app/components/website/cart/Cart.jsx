    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="border-b border-stone-200 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <Link
            href="/store"
            className="inline-flex items-center gap-2 text-stone-500 hover:text-amber-700 transition-colors text-sm mb-3"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        {cartItems.length === 0 ? (
          <div className="rounded-2xl border border-stone-200 bg-white p-12 text-center shadow-xs max-w-xl mx-auto">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-amber-50 text-amber-700 mb-4">
              <ShoppingBag className="h-8 w-8" />
            </div>
            <h2 className="text-xl font-semibold text-stone-900">Your cart is empty</h2>
            <p className="mt-2 text-sm text-stone-500">
              Looks like you haven't added any items to your cart yet. Browse our collections or sign in to view saved items.
            </p>
            <div className="mt-6 flex items-center justify-center gap-3">
              <Link
                href="/store"
                className="rounded-xl bg-amber-700 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-amber-800"
              >
                Browse Store
              </Link>
              <Link
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="flex-1 flex flex-col sm:flex-row justify-between gap-4">
                      ...
                      <div className="flex sm:flex-col items-center sm:items-end justify-between gap-3">
                        ...
                        <div className="flex items-center border border-stone-200 rounded-lg overflow-hidden">
                          <button
                            type="button"
                            onClick={() => dispatcher(decreaseQty(item._id))}
                          ...
                          <button
                            type="button"
                            onClick={() => dispatcher(increaseQty(item._id))}
                            className="p-2 hover:bg-stone-100 text-stone-600 transition-colors"
                          >
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl border border-stone-200 p-6 sticky top-6">
                ...
                <Link
                  href="/checkout"
                  className="w-full flex justify-center bg-amber-700 hover:bg-amber-800 text-white font-medium py-3.5 rounded-xl mt-6 transition-colors"
                >
                  Proceed to Checkout
                </Link>
