...
import { client, generateSlug, getImageValidationError } from '@/utils/helper';
            ...
            >
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <input type="file" name='image' accept="image/jpeg,image/png,image/webp" onChange={imageHandler} className="flex items-center justify-center w-full h-20 rounded-xl border-2 border-dashed border-gray-200 bg-gray-50" />

                        <div> 
                            {
                               formData.image &&  
                               <img src={URL.createObjectURL(formData.image)} className='w-20 h-20' alt="" />
                            }
